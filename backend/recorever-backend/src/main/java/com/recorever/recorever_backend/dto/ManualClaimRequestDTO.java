...
public class ManualClaimRequestDTO {
    ...
    private Long matching_lost_report_id;
    ...
    public Long getMatching_lost_report_id() {
        return matching_lost_report_id; }
    public void setMatching_lost_report_id(Long matching_lost_report_id) {
        this.matching_lost_report_id = matching_lost_report_id; }
}